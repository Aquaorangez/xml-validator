...
public interface XmlValidator {
	...
	/**
	 * Uses a StringStack (optionally more than one) to validate the nesting of XML
	 ...
	 *         Otherwise, a String[] containing error information is returned. The
	 *         array contents depend on the type of problem that occurs (see below):
	 * 
	 *         <pre>
	 ...
	 * @throws IOException
	 */
	public String[] validate(String xmlDocument) throws IOException;
